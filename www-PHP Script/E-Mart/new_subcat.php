...
<table id="structure">
	<tr>
		...
		<td id="page">
            <br />
            <h2>Add Subcat</h2>
			   <form action="create_subcat.php" method="post">

                    <p>Sub Catagory name:
					<input type="text" name="subcat_name" value="" id="subcat_name" />
                    </p>
						...
						<?php
                             ...
                             $products_set = mysql_query("SELECT * FROM products", $connection);
		                     if (!$products_set) {
		            	        die("Database query failed: " . mysql_error());
                             }

							$products_count = mysql_num_rows($products_set);
					...
					<select name="cat_id">
						<?php
                             $catagories_set = mysql_query("SELECT * FROM catagories", $connection);
		                     if (!$catagories_set) {
		            	        die("Database query failed: " . mysql_error());
                             }

							//$catagories = mysql_fetch_array($catagories_set);
                    ...
                    <input type="submit" value="Add Sub-Catagory" />
			  </form>
			  <br /><br /><br />
